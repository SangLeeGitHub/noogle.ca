...
import {JobDetailComponent} from '../job';
import { EmployerSearchComponent, EmployerCreationFormComponent, CreateEmployerComponent,InterviewerCreationFormComponent } from '../employer';
        ...
        return(
            <div>
                <div>
                    ...
                    <Switch>
                        <Route exact path={`${currentPath}/createEmployer`} component={CreateEmployerComponent}></Route>
